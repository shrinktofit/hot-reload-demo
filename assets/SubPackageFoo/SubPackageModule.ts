 ...
 * Name = SubPackageModule
 * DateTime = Tue Feb 22 2022 11:52:44 GMT+0800 (中国标准时间)
 * Author = shrinktofit
 * FileBasename = SubPackageModule.ts
 * FileBasenameNoExtension = SubPackageModule
 * URL = db://assets/SubPackageFoo/SubPackageModule.ts
 * ManualUrl = https://docs.cocos.com/creator/3.5/manual/zh/
 *
 */
 
@ccclass('SubPackageModule')
export class SubPackageModule extends Component {
    dummy = '';
